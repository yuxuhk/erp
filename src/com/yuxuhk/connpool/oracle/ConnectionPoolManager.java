...
public class ConnectionPoolManager {
	// 连接池存放
	public Hashtable<String, InitConnectionPool> pools = new Hashtable<String, InitConnectionPool>();
	...
	public void close(String poolName, Connection conn) {
		InitConnectionPool pool = getPool(poolName);
		try {
			if (pool != null) {
	...
	// 获得连接池
	public InitConnectionPool getPool(String poolName) {
		InitConnectionPool pool = null;
		if (pools.size() > 0) {
